...
The dynamic of $$\sigma$$ uses a "skewed parabola" function to account for the
...
parametrized by positive decay parameters $$\lambda_0$$ and $$\lambda_1$$.
...
$$\theta = (\delta, \gamma_0, \gamma_1, \lambda_0, \lambda_1, \kappa).$$
...
log-likelihood function with a weighted version that emphasised the more recent
